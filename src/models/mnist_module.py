# original refer to: https://github.com/ashleve/lightning-hydra-template/blob/main/src/models/mnist_module.py

# modify refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
# modify all type hints to higher python version (small case, built-in type)
# change metric import (MeanMetric, MetricCollection, MetricTracker)
# add pad_keys function from src/utils/logging_utils.py 
# add `criterion & metrics` as init params, remove hard-coded loss function and metrics in init
# modify init function 
# delete on_train_start() function
# modify training_step() function
# delete on_train_epoch_end() function
# add on_validation_epoch_start() function
# modify validation_step() function
# modify on_validation_epoch_end() function
# modify test_step() function
# delete on_test_epoch_end() function
# add predict_step() function

# ⚠️ NOTE：pay attention to when to add `sync_dist=True` or not in self.log
# all refer to https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
# and https://github.com/ashleve/lightning-hydra-template/blob/main/src/models/mnist_module.py
...
from src.utils import pad_keys
...
class MNISTLitModule(LightningModule):
    ...
    def __init__(
        ...
        # ⚠️ add `ignore` refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    ...
    # ⚠️ delete on_train_start() function
    # refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    '''
    ...
    def training_step(
        ...
        # ⚠️ modify refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    ...
    # ⚠️ delete on_train_epoch_end() function
    # refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    '''
    ...
    # ⚠️ add on_validation_epoch_start() function
    # refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    ...
    # ⚠️ delete on_test_epoch_end() function
    # refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    '''
    ...
    def setup(self, stage: str) -> None:
        ...
        """
        # `compile` parameter in configs/model/mnist.yaml
        if self.hparams.compile and stage == "fit":
            self.net = torch.compile(self.net)


    # ⚠️ add predict_step() function
    # refer to: https://github.com/nathanpainchaud/lightning-hydra-template/blob/main/src/lightning_hydra_template/models/mnist_module.py
    def predict_step(
